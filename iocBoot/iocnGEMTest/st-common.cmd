...
epicsEnvSet("NGEMCMD", "$(TOP)/util/copycmd.bat")
...
dbLoadRecords("$(TOP)/db/nGEM_settings.db","P=$(MYPVPREFIX),Q=$(IOCNAME):SET:,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=NGEM")
dbLoadRecords("$(TOP)/db/nGEM_stats.db","P=$(MYPVPREFIX),Q=$(IOCNAME):STAT:,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=NGEM")
...
dbLoadRecords("$(TOP)/db/nGEMAD.template","P=$(MYPVPREFIX),R=$(IOCNAME):AD:,PORT=NGEM,ADDR=0,TIMEOUT=1,DATATYPE=7")
